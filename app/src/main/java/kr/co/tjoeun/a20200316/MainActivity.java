package kr.co.tjoeun.a20200316;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        singUpTxt = findViewById(R.id.singUpTxt);

//        로그인버튼의 글자를 => 회원가입으로 바꾸자
        loginBtn.setText("회원가입");

//       비밀번호 찾기 텍스트뷰를 => JAVA에서 "비번 찾기" 로변경
...
//        클릭은 버튼 뿐 아니라 모든 뷰가 다 눌릴 수 있다. => 텍스트뷰도 클릭.
        ...
        loginBtn.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                return true;// 손을 뗐을때, onClick실행을 막을 건지?
            }
        });
